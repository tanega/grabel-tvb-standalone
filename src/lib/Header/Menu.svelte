...
<div class="relative z-20">
	<div class="relative z-20 bg-white shadow flex justify-center items-center">
		<button
			type="button"
		...
		<Popover class="flex flex-none max-w-7xl px-4 py-6 sm:px-6 lg:px-8" let:open>
			...
			{#if open}
				<div transition:slide>
					...
					>
						...
						<div class="relative mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-1">
							<div class="bg-gray-50 px-4 py-8 sm:py-12 sm:px-6 lg:px-8 xl:pl-12">
								<div>
									<h3 class="text-base font-medium text-gray-500">Continuités Écologiques</h3>
											...
											>
												<div class="hidden flex-shrink-0 sm:block">
													<img
														...
														src="https://images.unsplash.com/photo-1448375240586-882707db888b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2300&q=80"
														alt=""
													/>
												</div>
										...
										<li class="flow-root">
											...
											>
												<div class="hidden flex-shrink-0 sm:block">
													<img
														class="h-20 w-32 rounded-md object-cover"
														src="https://images.unsplash.com/photo-1592083646587-2c84f8e0fd2b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2300&q=80"
														alt=""
													/>
												</div>
												<div class="min-w-0 flex-1 sm:ml-8">
