    ...
    <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
        ...
        <div class="mt-8 sm:flex">
          <div class="rounded-md shadow">
            <a
              ...
              >Voir les partenaires</a
            >
          </div>
          <div class="mt-3 sm:mt-0 sm:ml-3">
            <a
              href="#"
              class="flex items-center justify-center rounded-md border border-transparent bg-teal-100 px-5 py-3 text-base font-medium text-teal-700 hover:bg-teal-200"
      ...
      >
        ...
        >
          <img
            class="max-h-12"
            src="/images/logos/natural-solutions.png"
        ...
        >
          <img
            class="max-h-12"
            src="/images/logos/ecolos-euziere.jpeg"
            alt="Écologistes de l'Euzière"
          />
        </div>
      </div>
    </div>
