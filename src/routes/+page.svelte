...
<div class="mx-auto w-full max-w-7xl pt-16 pb-20 text-center lg:py-48 lg:text-left">
	<div class="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
		...
		>
			<span class="block xl:inline">corridors écologiques</span>
			<span class="block text-teal-600 xl:inline">graphes paysagers</span>
		</h1>
		<p class="mx-auto mt-3 max-w-md text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">
			Prototype de modélisation pour la commune de Grabels dans le cadre de l'appel à projet Smart
			City pour Montpellier Méditerranée Métropole
		</p>
...
>
	<img
		...
		src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/VilleGrabels.jpg/1200px-VilleGrabels.jpg"
		alt=""
	/>
</div>
		...
		<div class="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
			...
			>
				<div>
					<dt>
						<div
							class="flex h-12 w-12 items-center justify-center rounded-md bg-teal-500 text-white"
						>
						...
						<p class="mt-5 text-lg font-medium leading-6 text-gray-900">Géovisualisation</p>
					</dt>
				...
				<div>
					<dt>
						...
						<p class="mt-5 text-lg font-medium leading-6 text-gray-900">Analyse diachronique</p>
					</dt>
					<dd class="mt-2 text-base text-gray-500">
				...
				<div>
					<dt>
						...
						<p class="mt-5 text-lg font-medium leading-6 text-gray-900">Continuités écologiques</p>
					</dt>
					<dd class="mt-2 text-base text-gray-500">
				...
				<div>
					<dt>
						...
						<p class="mt-5 text-lg font-medium leading-6 text-gray-900">Méthodologie ouverte</p>
					</dt>
					<dd class="mt-2 text-base text-gray-500">
